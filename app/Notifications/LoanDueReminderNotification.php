...
class LoanDueReminderNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                ->subject(Lang::get('Loan Reminder by Admin'))
                ->view('emails.loanduereminder',
                [
                    'loan' => $this->loan,
                    'user' => $notifiable,
                    'date' => $this->date,
                ...
                // ->line('This is just a reminder for your loan by an Admin.')
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'status' => "reminder",
            'message' =>"Your Loan of N".$this->loan->amount." for ".$this->loan->reason." will expire in on ".$this->date,
        ];
    }
    /**
