    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <div>
                    <p style="font-weight:bold; font-size: larger;">Admin Password Reset</p>
                    <div style="font-weight: bold;">Hello {{$name}},</div>
                    <div style="padding-bottom: 20px;">
                        Reset your password on your Trader Lenda Admin account. Please click on the link below to reset your password or ignore if you didn't make this request.
                    </div>
                    <a href="{{url(route('admin.password.reset', ['token' => $token, 'email'=>$email], false))}}" target="_blank" rel="noopener noreferrer"><button class="btn btn-primary" style="background-color: #24348B; cursor: pointer;" >Reset Password</button></a>

                    <div style="color:rgb(222, 230, 236); padding: 20px 0px;">
                        or you can copy and past the URL below into your web broswer
                        <a href="{{url(route('admin.password.reset', ['token' => $token, 'email'=>$email], false))}}" target="_blank" rel="noopener noreferrer">{{url(route('admin.password.reset', ['token' => $token, 'email'=>$email], false))}}</a>
                    </div>
