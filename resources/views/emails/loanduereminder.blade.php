    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <div>
                    <div>
                        <p style="font-weight:bold; font-size: larger;">Loan Due Reminder by Admin</p>
                        <h3>Hello {{ucfirst($user->first_name)}} {{ucfirst($user->last_name)}},</h3>
                        <div style="padding-bottom: 2px;">
                            <p style="color:black; font-size:16px;">This is just a reminder for your loan due by an Admin.</p>
                           <p style="color:black; font-size:16px;">Your Loan is going to be expired on <strong>{{$date}}</strong></p>
                        </div>
                        <h2>Your Loan Amount: <strong style="font-size:20px;">₦{{number_format($loan->amount)}}</strong></h2>
                        <h2>Reason: <strong style="font-size:20px;">₦{{$loan->reason}}</strong></h2>
