    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <div>
                    <div>
                        <p style="font-weight:bold; font-size: larger;">Loan Disbursed Notification</p>
                        <h3>Hello {{ucfirst($user->first_name)}} {{ucfirst($user->last_name)}},</h3>
                        <div style="padding-bottom: 2px;">
                           <p style="color:black; font-size:16px;">Your Requested loan for <strong>{{$loan->reason}}</strong> has been Disbursed by Trade Lenda Admins.</p>
                        </div>
