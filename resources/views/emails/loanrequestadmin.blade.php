    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <div>
                    <div>
                        <p style="font-weight:bold; font-size: larger;">Loan Request Notification</p>
                        <h3>Hi Dear {{ucfirst($admin->name)}},</h3>
                        <div style="padding-bottom: 2px;">
                           <p style="color:black; font-size:16px;">A User has Requested a loan for <strong>{{$loan->reason}}</strong> on the Trade Lenda website.</p>
                        </div>
                        <h2>The Loan Amount: <strong style="font-size:20px;">₦{{number_format($loan->amount)}}</strong></h2>

                        <a href="{{url('/admin/notifications')}}" target="_blank" rel="noopener noreferrer">
