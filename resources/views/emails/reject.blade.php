                ...
                <div>
                    ...
                    <div>
                        ...
                        <div style="padding-bottom: 2px;">
                           <p style="color:black; font-size:16px;">Your Requested loan for <strong>{{$loan->reason}}</strong> has been declined by Admins for some reasons...</p>
                        </div>
                        <h2>Your Loan Amount: <strong style="font-size:20px;">₦{{number_format($loan->amount)}}</strong></h2>

                        <h2>Decline Reason: <strong style="font-size:20px;">{{$loan->note}}</strong></h2>
