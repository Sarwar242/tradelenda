...
! function(p, r, u) {
    p.fn.extend({
        scrollspy: function(l) {
            var t = { namespace: "scrollspy", activeClass: "active", animate: !1, duration: 1e3, offset: 0, container: r, replaceState: !1 };
            l = p.extend({}, t, l);

            function s(t, e) { return parseInt(t, 10) + parseInt(e, 10) }

            function c(t) { for (var e = 0; e < t.length; e++) p(t[e]).parent().removeClass(l.activeClass) }
            var h = "";
            return this.each(function() {
                for (var o = this, t = p(l.container), i = p(o).find("a"), e = 0; e < i.length; e++) {
                    var a = i[e];
                    p(a).on("click", function(t) {
                        var e, a = p(this).attr("href"),
                            n = p(a);
                ...
                function n() { for (var t, e = { top: s(p(this).scrollTop(), Math.abs(l.offset)), left: p(this).scrollLeft() }, a = 0; a < f.length; a++) { var n = f[a]; if (e.top >= n.top && e.top < n.bottom) { var r = n.hash; if (t = function(t, e) { for (var a = 0; a < t.length; a++) { var n = p(t[a]); if (n.attr("href") === e) return n } }(i, r)) { l.onChange && h !== r && (l.onChange(n.element, p(o), e), h = r), l.replaceState && history.replaceState({}, "", "/" + r), c(i), t.parent().addClass(l.activeClass); break } } }!t && "exit" !== h && l.onExit && (l.onExit(p(o), e), c(i), h = "exit", l.replaceState && history.replaceState({}, "", "/")) }
                var f = function(t) {
                    for (var e = [], a = 0; a < t.length; a++) {
                        var n, r, o = t[a],
                            i = p(o).attr("href"),
                            f = p(i);
                        0 < f.length && (r = (n = Math.floor(f.offset().top)) + Math.floor(f.outerHeight()), e.push({ element: f, hash: i, top: n, bottom: r }))
                    }
                    return e
                }(i);
                t.bind("scroll." + l.namespace, function() { n() }), p(u).ready(function(t) { n() })
            })
        }
    })
...
! function(a, d, p) {
    "use strict";
    a.fn.scrollUp = function(l) { a.data(p.body, "scrollUp") || (a.data(p.body, "scrollUp", !0), a.fn.scrollUp.init(l)) }, a.fn.scrollUp.init = function(l) {
        ...
        switch (c.scrollTitle && n.attr("title", c.scrollTitle), n.appendTo("body"), c.scrollImg || c.scrollTrigger || n.html(c.scrollText), n.css({ display: "none", position: "fixed", zIndex: c.zIndex }), c.activeOverlay && a("<div/>", { id: c.scrollName + "-active" }).css({ position: "absolute", top: c.scrollDistance + "px", width: "100%", borderTop: "1px dotted" + c.activeOverlay, zIndex: c.zIndex }).appendTo("body"), c.animation) {
            case "fade":
        ...
        s = "top" === c.scrollFrom ? c.scrollDistance : a(p).height() - a(d).height() - c.scrollDistance, a(d).scroll(function() { a(d).scrollTop() > s ? i || (n[o](r), i = !0) : i && (n[e](r), i = !1) }), c.scrollTarget ? "number" == typeof c.scrollTarget ? t = c.scrollTarget : "string" == typeof c.scrollTarget && (t = Math.floor(a(c.scrollTarget).offset().top)) : t = 0, n.click(function(l) { l.preventDefault(), a("html, body").animate({ scrollTop: t }, c.scrollSpeed, c.easingType) })
    }, a.fn.scrollUp.defaults = { scrollName: "scrollUp", scrollDistance: 300, scrollFrom: "top", scrollSpeed: 300, easingType: "linear", animation: "fade", animationSpeed: 200, scrollTrigger: !1, scrollTarget: !1, scrollText: "Scroll to top", scrollTitle: !1, scrollImg: !1, activeOverlay: !1, zIndex: 2147483647 }, a.fn.scrollUp.destroy = function(l) { a.removeData(p.body, "scrollUp"), a("#" + a.fn.scrollUp.settings.scrollName).remove(), a("#" + a.fn.scrollUp.settings.scrollName + "-active").remove(), 7 <= a.fn.jquery.split(".")[1] ? a(d).off("scroll", l) : a(d).unbind("scroll", l) }, a.scrollUp = a.fn.scrollUp
}(jQuery, window, document);
...
! function(i, e) { "function" == typeof define && define.amd ? define(["jquery"], i) : "object" == typeof module && module.exports ? module.exports = function(e, t) { return void 0 === t && (t = "undefined" != typeof window ? require("jquery") : require("jquery")(e)), i(t), t } : i(e) }(function(l) {
    var m = "day",
        ...
        d = "second",
        n = { d: m, h: a, m: s, s: d },
        u = { list: [d, s, a, m], next: function(e) { var t = this.list.indexOf(e); return t < this.list.length && this.list[t + 1] }, prev: function(e) { var t = this.list.indexOf(e); return 0 < t && this.list[t - 1] } },
        o = { year: 2034, month: 7, day: 31, hour: 0, minute: 0, second: 0, timeZone: "local", ignoreTransferTime: !1, layout: "dhms", periodic: !1, periodInterval: 7, periodUnit: "d", doubleNumbers: !0, effectType: "none", lang: "eng", headTitle: "", footTitle: "", afterDeadline: function(e) { e.bodyBlock.html('<p style="font-size: 1.2em;">The countdown is finished!</p>') } },
        ...
        c = {
            init: function(e) {
                ...
                return this.each(function() { l(this).data("syotimer-options", t), c._render.apply(this, []), c._perSecondHandler.apply(this, []) })
            },
            _render: function() {
            ...
            _applyEffectSwitch: function(e, t) {
                ...
                var i, n, o, r = this,
                    a = l(r);
                "none" === e ? setTimeout(function() { c._perSecondHandler.apply(r, []) }, 1e3) : "opacity" !== e || (i = a.data("syotimer-items")[t]) && (n = u.next(t), o = i.data("syotimer-unit-value"), l(".syotimer-cell__value", i).animate({ opacity: .1 }, 1e3, "linear", function() { c._perSecondHandler.apply(r, []) }), n && 0 === o && c._applyEffectSwitch.apply(r, [e, n]))
            }
        },
        y = {
    ...
    }, l.syotimerLang = { rus: { second: ["Ã‘ÂÃÂµÃÂºÃ‘Æ’ÃÂ½ÃÂ´ÃÂ°", "Ã‘ÂÃÂµÃÂºÃ‘Æ’ÃÂ½ÃÂ´Ã‘â€¹", "Ã‘ÂÃÂµÃÂºÃ‘Æ’ÃÂ½ÃÂ´"], minute: ["ÃÂ¼ÃÂ¸ÃÂ½Ã‘Æ’Ã‘â€šÃÂ°", "ÃÂ¼ÃÂ¸ÃÂ½Ã‘Æ’Ã‘â€šÃ‘â€¹", "ÃÂ¼ÃÂ¸ÃÂ½Ã‘Æ’Ã‘â€š"], hour: ["Ã‘â€¡ÃÂ°Ã‘Â", "Ã‘â€¡ÃÂ°Ã‘ÂÃÂ°", "Ã‘â€¡ÃÂ°Ã‘ÂÃÂ¾ÃÂ²"], day: ["ÃÂ´ÃÂµÃÂ½Ã‘Å’", "ÃÂ´ÃÂ½Ã‘Â", "ÃÂ´ÃÂ½ÃÂµÃÂ¹"], handler: "rusNumeral" }, eng: { second: ["second", "seconds"], minute: ["minute", "minutes"], hour: ["hour", "hours"], day: ["day", "days"] }, por: { second: ["segundo", "segundos"], minute: ["minuto", "minutos"], hour: ["hora", "horas"], day: ["dia", "dias"] }, spa: { second: ["segundo", "segundos"], minute: ["minuto", "minutos"], hour: ["hora", "horas"], day: ["dÃƒÂ­a", "dÃƒÂ­as"] }, heb: { second: ["Ã—Â©Ã— Ã—â„¢Ã—â€", "Ã—Â©Ã— Ã—â„¢Ã—â€¢Ã—Âª"], minute: ["Ã—â€œÃ—Â§Ã—â€", "Ã—â€œÃ—Â§Ã—â€¢Ã—Âª"], hour: ["Ã—Â©Ã—Â¢Ã—â€", "Ã—Â©Ã—Â¢Ã—â€¢Ã—Âª"], day: ["Ã—â„¢Ã—â€¢Ã—Â", "Ã—â„¢Ã—Å¾Ã—â„¢Ã—Â"] }, universal: function(e) { return 1 === e ? 0 : 1 }, rusNumeral: function(e) { var t = 4 < e % 100 && e % 100 < 20 ? 2 : [2, 0, 1, 1, 1, 2][e % 10 < 5 ? e % 10 : 5]; return t }, getNumeral: function(e, t, i) { var n = this[l.syotimerLang[t].handler || "universal"](e); return l.syotimerLang[t][i][n] } }
}, window.jQuery);
...
! function($) {
    ...
    $.fn.meanmenu = function(e) {
        var n = { meanMenuTarget: jQuery(this), meanMenuContainer: ".acavo-responsive-menu", meanMenuClose: "X", meanMenuCloseSize: "18px", meanMenuOpen: "<span /><span /><span />", meanRevealPosition: "right", meanRevealPositionDistance: "0", meanRevealColour: "", meanScreenWidth: "480", meanNavPush: "", meanShowChildren: !0, meanExpandableChildren: !0, meanExpand: "+", meanContract: "-", meanRemoveAttrs: !1, onePage: !1, meanDisplay: "block", removeElements: "" };
        e = $.extend(n, e);
...
! function(a, b, c, d) {
    function e(a) { return a.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") }
    a.extend(a.fn, {
        accrue: function(b) {
            return b = a.extend({ calculationMethod: g }, a.fn.accrue.options, b), this.each(function() {
                ...
                if ("compare" == b.mode) { f(c, b, "rate_compare") }
                var d;
                ...
                e(c, b, d), "button" == b.operation ? (0 === c.find("button").length && 0 === c.find("input[type=submit]").length && 0 === c.find("input[type=image]").length && c.find(".form").append('<button class="accrue-calculate">' + b.button_label + "</button>"), c.find("button, input[type=submit], input[type=image]").each(function() { a(this).click(function(a) { a.preventDefault(), e(c, b, d) }) })) : c.find("input, select").each(function() { a(this).bind("keyup change", function() { e(c, b, d) }) }), c.find("form").each(function() { a(this).submit(function(a) { a.preventDefault(), e(c, b, d) }) })
            })
        }
    }), a.fn.accrue.options = { mode: "basic", operation: "keyup", default_values: { amount: "₦7,500", rate: "5%", rate_compare: "1.49%", term: "6m" }, field_titles: { amount: "Loan Amount", rate: "Rate (APR)", rate_compare: "Comparison Rate", term: "Term" }, button_label: "Calculate", field_comments: { amount: "", rate: "", rate_compare: "", term: "Format: 6m,12m, 36m, 3y, 7y" }, response_output_div: ".results", response_basic: "<p><strong>Monthly Payment:</strong>₦%payment_amount%</p><p><strong>Number of Payments:</strong>%num_payments%</p><p><strong>Total Payments:</strong>₦%total_payments%</p><p><strong>Total Interest:</strong>₦%total_interest%</p>", response_compare: '<p class="total-savings">Save $%savings% in interest!</p>', error_text: '<p class="error">Please fill in all fields.</p>', callback: function(a, b) {} };
    var f = function(a, b, c) { var d; return a.find(".accrue-" + c).length ? d = a.find(".accrue-" + c) : a.find("." + c).length ? d = a.find("." + c) : a.find("input[name~=" + c + "]").length ? a.find("input[name~=" + c + "]") : d = "", "string" != typeof d ? d.val() : "term_compare" == c ? !1 : (a.find(".form").append('<div class="accrue-field-' + c + '"><p><label>' + b.field_titles[c] + ':</label><input type="text" class="' + c + '" value="' + b.default_values[c] + '" />' + (b.field_comments[c].length > 0 ? "<small>" + b.field_comments[c] + "</small>" : "") + "</p></div>"), a.find("." + c).val()) },
        g = function(b, c, d) {
    ...
    a.loanInfo = function(a) {
        ...
        var e = c / 100 / 12,
            f = Math.pow(1 + e, d),
            g = b * f * e / (f - 1);
        return b * c * d > 0 ? { original_amount: b, payment_amount: g, payment_amount_formatted: g.toFixed(2), num_payments: d, total_payments: g * d, total_payments_formatted: (g * d).toFixed(2), total_interest: g * d - b, total_interest_formatted: (g * d - b).toFixed(2) } : 0
        ...
        return g > 0 ? { principal_amount: g, principal_amount_formatted: (1 * g).toFixed(2), payment_amount: b, payment_amount_formatted: (1 * b).toFixed(2), num_payments: d, total_payments: b * d, total_payments_formatted: (b * d).toFixed(2), total_interest: b * d - g, total_interest_formatted: (b * d - g).toFixed(2) } : 0
    }
}(jQuery, window, document);
